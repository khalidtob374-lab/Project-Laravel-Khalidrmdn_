  ...
  <nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/about" aria-current="page" class="rounded-md bg-gray-900 px-3 py-3 text-sm font-medium text-white">About</a>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="/about" aria-current="page" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">About</a>
        ...
        <a href="/gallery" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Gallery</a>
        ...
        <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            <div class="w-full md:w-1/2 flex justify-center">
                <img src="/img/foto1.jpg" 
                     alt="Profile Image" 
                     class="h-auto w-full max-w-sm rounded-3xl object-cover shadow-xl">
            </div>

            <!-- Bagian Kanan: Teks About Me -->
            <div class="w-full md:w-1/2">
                <h2 class="text-4xl font-bold text-indigo-950 mb-4">About Me</h2>
                <p class="text-gray-600 text-lg leading-relaxed mb-8">
                    Halo! Saya seorang mahasiswa yang sedang belajar web development menggunakan Laravel, HTML, CSS, dan JavaScript.
                </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                        <h3 class="font-bold text-gray-800 text-sm">Hobi</h3>
                        <p class="text-gray-500 text-sm mt-1">Ngoding, Gaming, Traveling</p>
                    </div>

                    <!-- Box 2: Keahlian -->
                    <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                        <h3 class="font-bold text-gray-800 text-sm">Keahlian</h3>
                        <p class="text-gray-500 text-sm mt-1">HTML, CSS, JavaScript, Laravel</p>
                    </div>

                    <!-- Box 3: Cita-cita -->
                    <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                        <h3 class="font-bold text-gray-800 text-sm">Cita-cita</h3>
                        <p class="text-gray-500 text-sm mt-1">Menjadi Fullstack Developer</p>
                    </div>
                </div>
            </div>
