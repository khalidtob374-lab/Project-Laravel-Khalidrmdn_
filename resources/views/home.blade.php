        ...
        <div class="flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="w-full md:w-1/2">
                ...
                <p class="mt-4 text-lg text-gray-500">
                    Website sederhana menggunakan Laravel yang berisi profil, pengalaman, dan gallery momen terbaik.
                </p>
                <div class="mt-8">
                    <a href="/about" class="rounded-md bg-indigo-950 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        Explore Now
                    </a>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/2 flex justify-center md:justify-end">
                <img src="/img/foto1.jpg" 
                     alt="Profile Image" 
                     class="h-auto w-full max-w-md rounded-3xl object-cover shadow-lg">
            </div>
        </div>
    </div>
  </main>
